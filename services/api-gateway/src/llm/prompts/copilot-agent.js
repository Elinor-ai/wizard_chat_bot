...
const BASE_ROLE = "You are Wizard's recruiting copilot. You act as a short ReAct-style agent.";
const BASE_MISSION =
...
export function buildCopilotAgentPrompt(context = {}) {
  ...
  const payload = {
    ...
    mission: stageConfig.mission ?? BASE_MISSION,
    guardrails: [
      ...BASE_GUARDRAILS,
      ...(stageConfig.guardrails ?? [])
    ],
    outputContract: {
