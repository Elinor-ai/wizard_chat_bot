...
export const LLM_CORE_TASK = {
  ...
  JOB_INTEL_AGENT: "job_intel_agent",
  JOB_PAGE_INTERPRETER: "job_page_interpreter",
  JOB_SNIPPET_CLASSIFIER: "job_snippet_classifier",
  JOB_COVERAGE_CRITIC: "job_coverage_critic",
